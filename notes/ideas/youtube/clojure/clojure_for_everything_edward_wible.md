...
I'd like to talk to you this morning about nubank and some experiences within nubank but I'm going to try to tie it back to things that you might get it to apply in your day to day so hopefully, they'll be able to make this relevant for you.

[0):00:46] The title is “Clojure for Everything” or maybe “Clojure Everywhere” and hopefully it be clear by the end.

[00:00:56] nubank tests run very very quickly. And for those on the inside that's been plenty profoundly stressful experience. But it also very rewarding to see people using the products we built and reacting positively to the change that we are trying to bring to the market ..um first in Brazil but now we're talking about going to Mexico, to Argentina. So we're starting the international expansion
